...
sudo dnf install -y i3 xinit xfce4-terminal feh nano git mutt weechat ranger firefox xorg-x11-server-Xorg kernel-devel broadcom-wl compat-openssl10 seahorse gtkhash ffmpeg ffmpeg-libs vlc fuse-exfat exfat-utils peek powershell dkms
clear
...
git clone https://github.com/theRealc2c2/dotfiles
clear
